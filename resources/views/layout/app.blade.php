           ...
           <ul class="navbar-nav navbar-list">
              ...
              <li class="nav-item d-none d-lg-none">
               ...
               @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link material-symbols-outlined" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
                            @endif
                        ...
                        <div class="sub-drop dropdown-menu caption-menu" aria-labelledby="drop-down-arrow">
                            ...
                            <div class="card-body p-0 ">
                                ...
                                <div class="d-flex align-items-center iq-sub-card">
                                    ...
                                    <div class="ms-3">
                                        <a href="{{ route('logout') }}" class="mb-0 h6" onclick="event.preventDefault();
     ...
     <div class="offcanvas-body small">
        <div class="d-flex flex-wrap align-items-center">
           <div class="text-center me-3 mb-3">
              <img src="images/icon/08.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>Facebook</h6>
           </div>
           <div class="text-center me-3 mb-3">
              <img src="images/icon/09.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>Twitter</h6>
           </div>
           <div class="text-center me-3 mb-3">
              <img src="images/icon/10.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>Instagram</h6>
           </div>
           <div class="text-center me-3 mb-3">
              <img src="images/icon/11.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>Google Plus</h6>
           </div>
           <div class="text-center me-3 mb-3">
              <img src="images/icon/13.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>LinkedIn</h6>
           </div>
           <div class="text-center me-3 mb-3">
              <img src="images/icon/12.png" class="img-fluid rounded mb-2" alt="" loading="lazy">
              <h6>YouTube</h6>
           </div>
        </div>
     </div>
